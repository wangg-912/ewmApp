...
var per = [
    ...
    {id:"020",class:"终端设备",icon:'../resource/physical/HostDevice/computervsd.png',name:"个人主机",tag:"pc ",status:"发布"},
    ...
    {id:"013",class:"终端设备",icon:'../resource/physical/HostDevice/server.jpg',name:"服务器",tag:"server",status:"发布"},
    {id:"014",class:"域设备",icon:'../resource/physical/AreaDevice/domain.png',name:"部门 ",tag:"department",status:"发布"},
    {id:"015",class:"域设备",icon:'../resource/physical/AreaDevice/branch.png',name:"分支 ",tag:"branch",status:"发布"},
    {id:"016",class:"线路",icon:'../resource/physical/Line/line.bmp',name:"ethernet",tag:"网线",status:"发布"},
    {id:"017",class:"拓扑背景",icon:'../resource/physical/Background/jigui.png',name:"单开机柜",tag:"机柜",status:"发布"},
    {id:"018",class:"拓扑背景",icon:'../resource/physical/Background/2jigui.png',name:"对开机柜",tag:"对开机柜",status:"发布"},
    {id:"019",class:"拓扑背景",icon:'../resource/physical/Background/beijing_1.png',name:"北京地图",tag:"北京地图",status:"发布"}
];
